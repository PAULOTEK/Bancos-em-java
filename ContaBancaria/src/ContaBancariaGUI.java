...
public class ContaBancariaGUI extends javax.swing.JFrame {
    ...
    ContaBancaria contaPaulo = new ContaBancaria();
    ContaBancaria contaJunior = new ContaBancaria();
    ContaBancaria contaKarina = new ContaBancaria();
    ContaBancaria contaLeticia = new ContaBancaria();
    ContaBancaria contaDeny = new ContaBancaria();
    /**
     * Creates new form ContaBancariaGUI
     */
    ...
    private void initComponents() {
        ...
        comboConta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Paulo", "Junior", "Karina", "Leticia", "Deny" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblSaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(117, 117, 117)
    ...
    private void botaoOperacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoOperacaoActionPerformed
        ...
        switch(comboOperacao.getSelectedIndex()){
            case 0:
                contaSelecionada = contaDeny;
                break;
            case 1: 
                contaSelecionada = contaPaulo;
                break;
            case 2:
                contaSelecionada = contaJunior;
                break;
            case 3:
                contaSelecionada = contaKarina;
                break;
            case 4:
                contaSelecionada = contaLeticia;
                break;
        ...
        }else if (comboOperacao.getSelectedIndex() == 1) {
